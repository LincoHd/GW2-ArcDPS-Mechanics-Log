...
const uint32_t MECHANIC_DAGDA_RESIDUAL_ANXIETY = 70283; 
...
const uint32_t MECHANIC_DECIMA_CHORUS_OF_THUNDER = 75523;
const uint32_t MECHANIC_DECIMA_FLUXLANCE_A = 75155;
const uint32_t MECHANIC_DECIMA_FLUXLANCE_B = 75450;
